...
def parse_args():
    ...
    parser.add_argument('--config',
                        default='configs/loft_foa_prompt/loft_foa_r50_fpn_2x_bonai_prompt_offset_mask_bbox.py',
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        default='work_dirs/loft_foa_r50_fpn_2x_bonai_prompt_offset_mask_bbox/epoch_32.pth', 
...
def main():
    ...
    for i, (building_bbox, img_matas, offsets) in enumerate(outputs):
        ...
        for box, offset in zip(building_bbox, offsets):
            # box[2] = box[2] - box[0]
            # box[3] = box[3] - box[1]
            # offsets[0] = offsets[0]*box[2]
            # offsets[1] = offsets[1]*box[3]
            ...
            id_cnt+=1
    mmcv.dump(json_ann, 'off_bbox_mask.json')
        # if rank == 0:
    #     if args.out:
